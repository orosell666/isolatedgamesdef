...
const ContactUs = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_7swdbt6', 'template_oo5bx5l', form.current, 'RaIxMhNlNOV-96lst')
  ...
  return (
    <div className="container  pt-5  col-lg-6 col-sm-7 contact card cardshade  jobpos ">
    <form ref={form} onSubmit={sendEmail} className='fs-4'>
      ...
      <textarea name="message" className="form-control border-0 textColor1" id="exampleFormControlTextarea1" rows="4" placeholder="Enter your message"></textarea>
       ...
       <form enctype="multipart/form-data" method="post" onsubmit="formSubmit()" className="fs-5">
    <label>Attach file:</label>
    
    <input type="file" name="my_file" className="form-control border-0 textColor1" id="exampleFormControlInput1" placeholder="Upload your CV" /> 
