...
import screenshot6 from "../images/Screenshot_6.jpg";
import screenshot7 from "../images/screenshot_7.jpg";
import screenshot8 from "../images/Screenshot_8.jpg";
import screenshot9 from "../images/Screenshot_9.jpg";
import screenshot10 from "../images/Screenshot_10.jpg";
import screenshot11 from "../images/Screenshot_11.jpg";
import screenshot12 from "../images/Screenshot_12.jpg";
import screenshot13 from "../images/Screenshot_13.jpg";
import screenshot14 from "../images/Screenshot_14.jpg";
...
const Travellers = () => {
    return(
        ...
        <iframe className="col-md-12 col-lg-9 embed-item embed-16by9 videoSize " src="https://www.youtube.com/embed/JDk0H02wYXs" title="Travellers Rest Trailer 2023" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
       </div></div>
        ...
        <div className="container  text-center col-9 ">
          <p className="fs-4">Craft, farm, build! In Travellers Rest you will have to use all the available tools to become the best tavern keeper in the kingdom. Create unique dishes and drinks to please your customers while you discover the world and its colorful characters. Take your establishment to the top in this exciting new adventure! </p>
          ...
          <a href="https://store.steampowered.com/app/727130/Between_the_Stars/"><img src={logoEPIC} className="mb-5 "  width={50} height={50}/></a>
            ...
            <div className="mx-auto card pt-5  rounded-3  col-7">
                ...
                <div className=" d-flex flex-wrap-reverse">
                  <img src={screenshot2} className="img-fluid    col-lg-6  col-sm-12 p-2" />
  ...
  <div className="carousel-inner">
    ...
    <div className="carousel-item">
      ...
      <img src={screenshot13} class="d-block w-100" alt="..." />
    </div>
    <div className="carousel-item">
    
      <img src={screenshot14} class="d-block w-100" alt="..." />
    </div>
      ...
      <div id="thumbcarousel" className="carousel slide carousel-indicators1 col-lg-7 mx-auto fondoCarousel2 " data-interval="false">
        ...
        <div className="carousel-inner scroll">
          <div className="item active d-flex m-2">
            <div data-target="#carousel" data-slide-to="0" className="thumb border-0"><button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" className="active thumbnail" aria-current="true" aria-label="Slide 1"><img src={screenshot1} className="d-block w-100" alt="..." /></button></div>
            <div data-target="#carousel" data-slide-to="1" className="thumb"><button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2" className="thumbnail"><img src={screenshot2} className="d-block w-100 border-0" alt="..." /></button></div>
            ...
            <div data-target="#carousel" data-slide-to="10" className="thumb "><button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="10" className=" thumbnail" aria-current="true" aria-label="Slide 12"><img src={screenshot12} className="d-block w-100" alt="..." /></button></div>
            <div data-target="#carousel" data-slide-to="10" className="thumb "><button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="10" className=" thumbnail" aria-current="true" aria-label="Slide 13"><img src={screenshot13} className="d-block w-100" alt="..." /></button></div>
            <div data-target="#carousel" data-slide-to="10" className="thumb "><button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="10" className=" thumbnail" aria-current="true" aria-label="Slide 14"><img src={screenshot14} className="d-block w-100" alt="..." /></button></div>
...
<div className=" splash3Game   pb-5 text-center">
    ...
    <div className="container-fluid col-lg-4 col-md-6">
      <div className="card mt-5 rounded-3 w-100 justify-content-evenly ">
        ...
        <img src={logoShame} className="mt-3 mb-3  ms-3 "  width={60} height={60} />
        ...
        <div className=" d-flex flex-wraper">
          <div className="container ">
                ...
                <p className="card-text"><small class="text-muted">3,308 Online</small></p></div>
                    ...
                    <Link><button type="button" className="btn moreBtn textColor1  ms-3 me-3 mt-2 " >
                       Join
